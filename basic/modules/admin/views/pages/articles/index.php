...
<div class="pull-right" style="padding-top: 20px;">
    <a href="<?php echo Url::to(['pages/article/index']);?>#" class="btn btn-warning"><i class="fa fa-plus"></i> Создать статью</a>
</div>
...
<script>
    ...
    function loadPage(page, order, asc) {
        $.ajax({
            url: '<?php echo Url::to(['pages/articles/articles']);?>',
            type: 'POST',
            data: {
                'page': page,
                'order': order,
    ...
    (function () {
        ...
        $('#tout').on('click', '.remove-btn', function () {
            ...
            $.ajax({
                url: '<?php echo Url::to(['pages/articles/remove']);?>',
                'type': 'POST',
                data: {
